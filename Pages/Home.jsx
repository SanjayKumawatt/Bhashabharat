...
function Home() {
    return (
        <div className="bg-[#F5F1EC] min-h-screen">
            ...
            <section id="best-sellers" className="flex flex-col items-center py-20">
                <div className="text-center mb-10">
                    <p className="uppercase text-sm mb-4 font-medium text-gray-600">
                        India’s finest craft-based designs
                    </p>
                    <h1 className="text-5xl font-semibold mb-4">Best Sellers</h1>
                ...
                <div className="flex gap-4">
                    <div className="bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300 w-[300px] flex flex-col justify-center items-center">
                        <img
                            src={topSeller1}
                            alt="Pure Tussar Silk Madhubani HandPainted Saree"
                        ...
                        <button className="uppercase text-sm bg-[#2B1416]  text-[#ae9b4dee] py-3 px-6 rounded mb-3">
                            + add to cart
                        </button>
                    </div>
                    <div className="bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300 w-[300px] flex flex-col justify-center items-center">
            ...
            <div className="bg-[#D7C39B]">
                ...
                <section id="best-sellers" className="flex flex-col items-center py-20">
                    <div className="text-center mb-10">
                        <h1 className="text-5xl font-semibold mb-4">Bhagalpuri Tussar Silk Saree</h1>
