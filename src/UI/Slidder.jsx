            ...
            {slides.map((slide, index) => (
                ...
                >
                    ...
                    <div className="absolute inset-0 bg-black/40 flex flex-col justify-center items-center md:items-start text-center md:text-left text-white px-4 sm:px-10 lg:px-20 z-20">
                        ...
                        {/* 🛑 BUTTON को LINK से बदला गया है */}
                        <Link 
                            // सभी स्लाइड्स को SAREES कलेक्शन पेज पर भेजें
                            to="/sarees" 
                            className="bg-white hover:bg-blue-600 hover:text-white text-black px-5 py-2 sm:px-6 sm:py-3 rounded text-sm sm:text-base transition duration-300"
                        >
                            {slide.button}
                        </Link>
